...
SystemInfo["HDMICEC"] = (fileExists("/dev/hdmi_cec") or  fileExists("proc/stb/cec/send") or fileExists("/dev/misc/hdmi_cec0")) and fileExists("/usr/lib/enigma2/python/Plugins/SystemPlugins/HdmiCEC/plugin.pyo")
...
SystemInfo["VideoModes"] = getChipSetString() in (  # 2160p and 1080p capable hardware...
	...
	"7241", "7356", "73565", "7358", "7362", "73625", "7424", "7425", "7552", "3716mv410", '7111'
) and (
